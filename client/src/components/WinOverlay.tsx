  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex flex-col items-center gap-3 p-6 mx-4 rounded-xl max-w-[360px] w-full"
        style={{
      ...
      >
        ...
        <motion.div
          ...
          className="max-w-52 max-h-52 w-fit h-fit rounded-lg overflow-hidden flex items-center justify-center shrink-0"
          style={{ boxShadow: '0 4px 16px rgba(60, 50, 40, 0.2)' }}
        >
          <img src={imageUrl} alt="完成" className="max-w-[13rem] max-h-[13rem] w-auto h-auto object-contain block" />
        </motion.div>
        ...
        <div className="text-center">
          ...
          >
            <div className="text-center">
              <p className="text-xl font-bold" style={{ color: '#C4463A' }}>{moveCount}</p>
              <p className="text-xs" style={{ color: '#8B8680' }}>步数</p>
            </div>
            <div className="w-px h-6" style={{ backgroundColor: '#D0C9BE' }} />
            <div className="text-center">
              <p className="text-xl font-bold" style={{ color: '#C4463A' }}>{formatTime(elapsedTime)}</p>
        ...
        >
          <button
            ...
            className="flex-1 min-w-[80px] py-2 rounded-lg text-sm font-semibold transition-all active:scale-95"
            style={{
